/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 3565e1b0dbdb8a6cc6e0d2493d34d92a)
// Runtime types generated with workerd@1.20260820.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	AUTH_STATE: KVNamespace;
	DB: D1Database;
	BROWSER: BrowserRun;
	DEPLOY_MODE: "scheduled-daily-et";
	MAX_HANDLES_PER_RUN: "1";
	MAX_POSTS_PER_HANDLE: "10";
	RUN_DEADLINE_MS: "45000";
	SCHEDULED_RUN_DEADLINE_MS: "300000";
	SCHEDULE_TIME_ZONE: "America/New_York";
	SCHEDULE_HOURS: "7,9,11,13,15,17,19";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOY_MODE" | "MAX_HANDLES_PER_RUN" | "MAX_POSTS_PER_HANDLE" | "RUN_DEADLINE_MS" | "SCHEDULED_RUN_DEADLINE_MS" | "SCHEDULE_TIME_ZONE" | "SCHEDULE_HOURS">> {}
}
